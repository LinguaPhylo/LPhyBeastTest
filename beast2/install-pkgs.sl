...
LB_ARGS="-l 2000000 -o $XML_DIR/h5n1.xml $LPHY_SCRIPTS/h5n1.lphy"
...
# RSV2 : 10M chain length
LB_ARGS="-l 10000000 -o $XML_DIR/RSV2long.xml $LPHY_SCRIPTS/RSV2.lphy"
$JAVA $MORE_ARG -Dbeast.user.package.dir="$BEAST_LIB" -Djava.library.path="$BEAST_LIB" -cp "$BEAST_LIB/launcher.jar:$LPHY_LIB/*" $APP_LB $LB_ARGS
echo ""
...
# h3n2 : 2M
LB_ARGS="-l 2000000 -o $XML_DIR/h3n2.xml $LPHY_SCRIPTS/h3n2.lphy"
$JAVA $MORE_ARG -Dbeast.user.package.dir="$BEAST_LIB" -Djava.library.path="$BEAST_LIB" -cp "$BEAST_LIB/launcher.jar:$LPHY_LIB/*" $APP_LB $LB_ARGS
